  ...
  <b-navbar toggleable="lg" type="light" variant="white">
    ...
    <b-collapse id="nav-collapse" is-nav>
      ...
      <b-navbar-nav v-else class="ml-auto">
        <b-nav-item v-if="user.roles.includes('ROLE_ADMIN')"><router-link class="btn bg-secondary text-light" to="/admin">Annonce en attente de validation({{productsNotValidCount}})</router-link></b-nav-item>
