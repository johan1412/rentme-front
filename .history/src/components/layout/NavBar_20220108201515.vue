  ...
  <b-navbar toggleable="lg" type="light" variant="white">
    ...
    <b-collapse id="nav-collapse" is-nav>
      ...
      <b-navbar-nav v-else class="ml-auto">
        <b-nav-item><router-link class="btn bg-secondary text-light" to="#">Annonce en attente de validation(34)</router-link></b-nav-item>
        <b-nav-item><router-link class="btn bg-secondary text-light" to="#">Ajouter une nouvelle catégorie</router-link></b-nav-item>
        <b-nav-item><router-link class="btn bg-secondary text-light" to="admin/categories">Mon compte</router-link></b-nav-item>
