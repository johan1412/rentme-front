    ...
    <div class="container m-auto">
      <form @submit.prevent="handleSubmit">
        ...
        <div class="form-group">
          ...
          <select v-model="parent" class="form-select" size="3" aria-label="size 3 select example" v-for=" parent in parentCategories">
...
export default {
  ...
  async mounted(){
    ...
    this.parentCategories = response.data.filter(category => category.getParent)
  },
  methods: {
