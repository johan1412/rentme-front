<template>
    <div class="cgu-bloc">
        ...
        <p>
            ...
            modalités de mise à disposition du site et des services par RENTME et de définir les
            conditions d’accès et d’utilisation des services par « l'Utilisateur ».
            Les présentes CGU sont accessibles sur le site via le lien « Conditions Générales d'Utilisation ».
            ...
            RENTME se réserve le droit de modifier unilatéralement et à tout moment le contenu des
            présentes CGU.
        </p>
